	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==jb1)
		{
			...
			try {
				...
				if(autoGeneratedID == 5)
				{
					ps = con.prepareStatement("DELETE FROM contable WHERE ConferenceID = 1;");
					ps.executeUpdate();
				}
		...
		if(e.getSource()==jb2)
		{
			...
			try {
				...
				String ColumnNames[] = { "ConferenceID","Name","Location","Year","Month","Date","Type","Proceedings","Number of Papers"};
				int i =0;
